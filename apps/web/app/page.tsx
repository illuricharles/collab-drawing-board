    ...
    <section className="bg-gradient-to-br from-blue-50 via-white to-purple-50 p-5 md:p-15 md:pt-12 relative overflow-hidden">
      ...
      <section className="md:max-w-4xl md:m-auto">
        ...
        <div className="text-center py-3">
          <h1 className="text-3xl font-bold mb-4 md:text-4xl md:mb-5 lg:text-5xl lg:mb-6">Collaborative <span className="bg-gradient-to-r from-blue-700 to-purple-700 bg-clip-text text-transparent">Drawing</span> Platform</h1>
          <p className="text-left text-gray-800 mb-5 md:text-lg md:px-2 md:mb-6 md:text-center lg:mb-8 lg:text-lg">
          ...
          <div className=" flex  justify-center gap-3 md:gap-x-5 lg:gap-x-6 flex-wrap">
            <button className="flex items-center justify-center bg-gradient-to-r from-blue-500 to-purple-500 text-white text-sm
            ...
            <button className="flex items-center justify-center border-blue-600 border-2
